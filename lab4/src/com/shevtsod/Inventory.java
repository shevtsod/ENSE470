...
public class Inventory {
    ...
    public void addReservoir(String name, double price, int capacity) {
        ...
        Reservoir res = new BaseReservoir();

        res = new CustomReservoirName(res);
        res.setName(name);

        res = new CustomReservoirPrice(res);
        res.setPrice(price);

        res = new CustomReservoirCapacity(res);
    ...
    /**
     * Get a reference to iterate through the list of reservoirs, but not modify
